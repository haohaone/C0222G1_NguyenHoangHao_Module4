    ...
    <div class=" bg-white">
        ...
        <form action="/" method="get" class="p-3">
            <div class="form-group">
                <input type="checkbox" class="form-control" name="lettuce">
                <span>Lettuce</span>
            </div>

            <div class="form-group">
                <input type="checkbox" class="form-control" name="tomato">
                <span>Tomato</span>
            </div>

            <div class="form-group">
                <input type="checkbox" class="form-control" name="mustard">
                <span>Mustard</span>
            </div>

            <div class="form-group">
                <input type="checkbox" class="form-control" name="sprouts">
                <span>Sprouts</span>
            </div>
