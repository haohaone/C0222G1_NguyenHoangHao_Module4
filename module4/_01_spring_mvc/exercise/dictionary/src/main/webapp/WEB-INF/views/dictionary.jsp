...
<div class="container">
    <div class=" bg-white">
        <div class="h1 center-box m-0">Tra cứu từ điển Anh - Việt</div>
        <form action="/" method="get" class="p-3">
            <div class="form-group">
                <label>Nhập từ tiếng Anh:</label>
                <input type="text" class="form-control" name="english">
                <p class="text-success font-weight-bold">${result}</p>
            </div>

            <div class="form-group footer">
                <button type="submit" class="btn btn-dark w-25 back-home">Tra cứu</button>
            </div>
        </form>
    </div>
</div>
