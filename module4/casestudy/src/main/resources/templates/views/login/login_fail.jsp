...
<div class="container-fluid w-100 h-100 p-0 m-0">
    <div class="row w-100 h-100 p-0 m-0">
        <div class="col-md-4 col-sm-1 p-0 m-0 "></div>
        <div class="col-md-4 col-sm-10 p-0 m-0 login">
            <div class="h-50 w-100 bg-white p-0 m-0 ">
                <div class=" login h-25 bg-white">
                    <img src="https://furamavietnam.com/wp-content/uploads/2018/08/logo.png"
                         class="logo">
                    <div class="text-primary title">Furama Login</div>
                </div>

                <form class="h-75 bg-white" action="/login" method="post">
                    <div class="p-3 bg-white">
                        ...
                        <div class="login-fail mt-4 mb-4 login">
        ...
        <div class="col-md-4 col-sm-1  p-0 m-0 main-content"></div>
    </div>
</div>
</body>
