            ...
            <div class="h-100 w-100 bg-white p-0 m-0 ">
                <div class=" login">
                    <img src="https://furamavietnam.com/wp-content/uploads/2018/08/logo.png"
                         class="logo">
                    <div class="text-primary title">Tạo mới nhân viên</div>
                </div>
                <form action="/employee?action=add" method="post">
                    <div class="p-3">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control border-primary text-dark" name="idCard">
                            <c:if test="${validate != null}">
                        ...
                        <div class="form-group ">
                            <label>Lương</label>
                            <input type="text" class="form-control border-primary text-dark" name="salary">
                            <c:if test="${validate != null}">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control border-primary text-dark" name="phone">
                            <c:if test="${validate != null}">
                        ...
                        <div class="form-group ">
                            <label>Email</label>
                            <input type="email" class="form-control border-primary text-dark" name="email">
                        </div>
                        <div class="form-group ">
                            <label>Địa chỉ</label>
                            <input type="text" class="form-control border-primary text-dark" name="address">
                            <c:if test="${validate != null}">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="email" class="form-control border-primary text-dark" name="account">
                            <c:if test="${validate != null}">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="password" class="form-control border-primary text-dark" name="password">
                            <c:if test="${validate != null}">
                                <label class="text-danger">${validate.get("password")}</label>
                            </c:if>
                        </div>
                        <div class="form-group">
                            <select name="roleUser" class="form-control custom-select">
                            ...
                            <c:if test="${validate != null}">
                                <label class="text-danger">${validate.get("roleUser")}</label>
                            </c:if>
                        </div>
                        <div class="form-group">
